...
public class dbtreeindex {
    class BTreeNodeKey<TKey extends Comparable<TKey> > extends dbkey implements Comparable<TKey> {
        TKey indexedKey;
    ...
    abstract class BTreeNode<TKey extends BTreeNodeKey<TKey>> {
