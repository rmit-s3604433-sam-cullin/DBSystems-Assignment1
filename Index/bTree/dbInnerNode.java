...
public class dbInnerNode<TKey extends Comparable<TKey> & IdbStorable<TKey>>  extends dbIndexNode<TKey>  {
	...
	public dbIndexNode<TKey> getChild(int index) {
		return (dbIndexNode<TKey>)this.children[index];
	}

	public void setChild(int index, dbIndexNode<TKey> child) {
	...
	private void insertAt(int index, TKey key, dbIndexNode<TKey> leftChild, dbIndexNode<TKey> rightChild) {
	...
	protected dbIndexNode<TKey> split() {
		...
		dbInnerNode<TKey> newRNode = new dbInnerNode<TKey>();
	...
	protected void fusionWithSibling(TKey sinkKey, dbIndexNode<TKey> rightSibling) {
		dbInnerNode<TKey> rightSiblingNode = (dbInnerNode<TKey>)rightSibling;
	...
	protected TKey transferFromSibling(TKey sinkKey, dbIndexNode<TKey> sibling, int borrowIndex) {
		dbInnerNode<TKey> siblingNode = (dbInnerNode<TKey>)sibling;
